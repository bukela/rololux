...
// var importOnce     = require('node-scss-import-once');
// var cssGlobbing    = require('gulp-css-globbing');
// var assetFunctions = require('node-scss-asset-functions');
...
gulp.task('sass', function() {
  gulp.src(mySass)
    ...
    .pipe(sass({
      includePaths: [
        // './node_modules/breakpoint-scss/stylesheets',
        // './node_modules/compass-mixins/lib',
        // './node_modules/susy/scss',
        // './node_modules/bootstrap-sass/assets/stylesheets', // bootstrap-scss 3.x
      ...
      sourceMapContents: true, // Needed for node-scss generation of the maps
      sourceMapEmbed: true,    // Needed to embed (inline) maps
      outFile: './mycss',      // Needed although unused in inline maps
      // importer: importOnce,    // arguments for node-scss-import-once
      // importOnce: {
      //   index: false,
...
// ------------------------
// Having watch within the task ensures that 'scss' has already ran before watching
//
